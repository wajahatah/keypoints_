...
# Example usage
base_directory = "C://Users//LAMBDA THETA//Downloads/keypoints"        # Path to the base directory containing the 'b<A>_<B>' folders
output_images_folder = "C:/OsamaEjaz/Qiyas_Gaze_Estimation/Wajahat_Yolo_keypoint/updated_dataset/train/images"     # Path to the output folder where copied images will be saved
output_labels_folder = "C:/OsamaEjaz/Qiyas_Gaze_Estimation/Wajahat_Yolo_keypoint/updated_dataset/train/labels"     # Path to the output folder where copied labels will be saved
